...
/** Utils for working with {@link tc.oc.util.bukkit.component.Component}s */
public class Components {
  ...
  /**
   * Convert text with legacy formatting codes to a {@link tc.oc.util.bukkit.component.Component}
   */
   ...
   *
   * @return {@link tc.oc.util.bukkit.component.Component}
   */
