...
public abstract class KitParserImpl implements KitParser {
  ...
  public KitParserImpl(MapFactory factory) {
    this.factory = factory;
  }

  /**
   * Return all {@link AttributeModifierImpl}s used by parsed {@link AttributeKit}s. We need to keep
  ...
  @Override
  public Kit parseKnockbackReductionKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseWalkSpeedKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseClearItemsKit(Element el) throws InvalidXMLException {
  ...
  */
  @Override
  public Kit parseFlyKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseArmorKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseItemKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parsePotionKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseAttributeKit(Element el) throws InvalidXMLException {
  ...
  @Override
  public Kit parseHealthKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Kit parseHungerKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Kit parseDoubleJumpKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Kit parseEnderPearlKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Collection<Kit> parseRemoveKits(Element parent) throws InvalidXMLException {
    Set<Kit> kits = Collections.emptySet();
  ...
  @Override
  public Kit parseGameModeKit(Element parent) throws InvalidXMLException {
    GameMode gameMode =
  ...
  @Override
  public Kit parseShieldKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Kit parseTeamSwitchKit(Element parent) throws InvalidXMLException {
  ...
  @Override
  public Kit parseMaxHealthKit(Element parent) throws InvalidXMLException {
