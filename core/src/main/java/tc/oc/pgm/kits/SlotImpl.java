...
public abstract class SlotImpl implements Slot {
  ...
  private SlotImpl(String key, int index) {
    this.key = key;
    this.index = index;
  ...
  public static class Player extends SlotImpl {
    ...
    /**
     * Convert a {@link PlayerInventory} slot index to a {@link SlotImpl} object. Returns null if
  ...
  public static class EnderChest extends SlotImpl {
