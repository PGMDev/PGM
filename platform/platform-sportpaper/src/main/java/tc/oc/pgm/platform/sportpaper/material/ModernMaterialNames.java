...
class ModernMaterialNames {
  ...
  static {
    ...
    put("POLAR_BEAR_SPAWN_EGG", 102, "MONSTER_EGG");
    put("LLAMA_SPAWN_EGG", 103, "MONSTER_EGG");
    put("PARROT_SPAWN_EGG", 105, "MONSTER_EGG");
    put("VILLAGER_SPAWN_EGG", 120, "MONSTER_EGG");
    put("ELDER_GUARDIAN_SPAWN_EGG", 4, "MONSTER_EGG");
    put("WITHER_SKELETON_SPAWN_EGG", 5, "MONSTER_EGG");
    put("STRAY_SPAWN_EGG", 6, "MONSTER_EGG");
    put("HUSK_SPAWN_EGG", 23, "MONSTER_EGG");
    put("ZOMBIE_VILLAGER_SPAWN_EGG", 27, "MONSTER_EGG");
    put("SKELETON_HORSE_SPAWN_EGG", 28, "MONSTER_EGG");
    put("ZOMBIE_HORSE_SPAWN_EGG", 29, "MONSTER_EGG");
    put("DONKEY_SPAWN_EGG", 32, "MONSTER_EGG");
    put("MULE_SPAWN_EGG", 32, "MONSTER_EGG");
    put("EVOKER_SPAWN_EGG", 34, "MONSTER_EGG");
    put("VEX_SPAWN_EGG", 35, "MONSTER_EGG");
    put("VINDICATOR_SPAWN_EGG", 36, "MONSTER_EGG");
    put("PIGLIN_SPAWN_EGG", 57, "MONSTER_EGG");
    put("TROPICAL_FISH_SPAWN_EGG", 0, "MONSTER_EGG");
    put("HOGLIN_SPAWN_EGG", 0, "MONSTER_EGG");
