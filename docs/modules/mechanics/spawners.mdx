...
The <label>`<spawners>`</label> module provides an easy way of spawning entities and items into the world, without using actual spawner blocks and NBT editors.

The module uses the same syntax as <a href="/modules/gear/kits">kits</a> to define items and makes use of a specific <a href="/modules/mechanics/regions">region</a> to spawn them in.
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="/modules/mechanics/regions">Region</a>
        </td>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <a href="/modules/mechanics/filters">Filter</a>
        </td>
        <td></td>
      </tr>
    </tbody>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <a href="/modules/gear/items">Item</a>
        </td>
      </tr>
    </tbody>
  </table>
