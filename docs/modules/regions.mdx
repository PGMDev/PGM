    ...
    <tbody>
      <tr>
        <td>
          ...
          <br />A rectangular solid from <label>X1,Y1,Z1</label> to{" "}
          <label>X2,Y2,Z2</label>.
          <br />
      ...
      <tr>
        <td>
          ...
          <br />A cylinder located at <label>X,Y,Z</label> with a radius of{" "}
          <label>R</label> and a height of <label>H</label>.
          <br />
      ...
      <tr>
        <td>
          ...
          <br />A sphere located at <label>X,Y,Z</label> with a radius of{" "}
          <label>R</label>.
          <br />
          <i>Only block bounded when using a finite radius.</i>
        </td>
      ...
      <tr>
        <td>
          ...
          <br />A circle located at <label>X,Z</label> with a radius of{" "}
          <label>R</label>. <br />
          <i>
      ...
      <tr>
        <td>
          <label>{`<below x="" y="" z="" id="abc"/>`}</label>|<label>
            {`<above x="" y="" z="" id="abc"/>`}
          </label>
          <br />
          Half of the world split at the specified axis.
          <br />
          If multiple axises are defined the specified parts of each axis are intersected
          and returned.
        </td>
        <td></td>
      </tr>
      ...
      <tr>
        <td>
          <label>{`<nowhere/>`}</label>
          <br />A reference-able zero size/position region, contains nothing.
          Can be referenced with the ID: <label>nowhere</label>
        </td>
        <td></td>
      </tr>
      <tr>
        <td>
          ...
          <br />A reference-able infinite size region, contains everything. Can
          be referenced with the ID: <label>everywhere</label>
        </td>
        <td></td>
      </tr>
    </tbody>
