...
public class PGMServer extends DedicatedServer {

  public static void main(String[] args) {
    init(PGMPlugin.class);
  }

  public static void init(Class<? extends JavaPlugin>... plugins) {
    try {
      new PGMServer(plugins).primaryThread.start();
  ...
  private PGMServer(Class<? extends JavaPlugin>... plugins) {
    super(
        new OptionParser() {
          {
