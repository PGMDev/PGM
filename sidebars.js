module.exports = {
  Modules: {
    ...
    Information: ["modules/tutorial", "modules/broadcasts", "modules/rules"],
    Environment: [
      "modules/world",
      "modules/time",
      "modules/border",
    ...
    Gear: [
      ...
      "modules/item-mods",
      "modules/crafting",
      "modules/repair-remove-keep",
      "modules/projectiles",
      "modules/tnt",
      "modules/kill-rewards",
      "modules/lootables",
    ],
  },
  Reference: {
  ...
  Guides: {
    "XML Pointers": ["guides/regions"],
    Contribute: ["guides/migrate"],
  },
};
